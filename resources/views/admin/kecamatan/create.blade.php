...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="fw-bold mb-1"><i class="fas fa-plus-circle me-2 text-accent"></i>Tambah Kecamatan Baru</h4>
        <p class="text-muted small mb-0">Masukkan data wilayah kecamatan beserta file peta GeoJSON.</p>
    </div>
        ...
        <form action="{{ route('admin.kecamatan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-wrapper">
                    ...
                    <input type="text" name="nama_kecamatan" id="nama_kecamatan"
                           ...
                           value="{{ old('nama_kecamatan') }}" placeholder="Contoh: Prabumulih Barat">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-wrapper">
                    ...
                    <input type="text" name="kode_kecamatan" id="kode_kecamatan"
                           ...
                           value="{{ old('kode_kecamatan') }}" placeholder="Contoh: 16.74.01">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-icon-wrapper">
                    ...
                    <input type="number" name="total_keseluruhan" id="total_keseluruhan"
                           ...
                           value="{{ old('total_keseluruhan', 0) }}" min="0" placeholder="Contoh: 120" required>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="number" name="total_2023" id="total_2023"
                               ...
                               value="{{ old('total_2023', 0) }}" min="0" required>
                    </div>
                    @error('total_2023')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="number" name="total_2024" id="total_2024"
                               ...
                               value="{{ old('total_2024', 0) }}" min="0" required>
                    </div>
                    @error('total_2024')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <input type="number" name="total_2025" id="total_2025"
                               ...
                               value="{{ old('total_2025', 0) }}" min="0" required>
                    </div>
                    @error('total_2025')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
            ...
            <div class="mb-4">
                <label for="geojson" class="form-label">
                    <i class="fas fa-draw-polygon text-accent me-1"></i>Upload File GeoJSON <span class="text-muted fw-normal">(Opsional)</span>
                </label>
                <div class="input-icon-wrapper">
                ...
                <p class="text-muted small mb-0 mt-2">
                    <i class="fas fa-info-circle me-1"></i>Format berkas yang didukung: <code>.json</code> atau <code>.geojson</code>
                </p>
            </div>
